...
class ClientListView(LoginRequiredMixin, generic.ListView):
    ...
    # ListView to use some existing "projects/index.html" template,
    # for example.
...
class ClientDetailView(LoginRequiredMixin, generic.DetailView):
    ...
    def get_queryset(self):
        # This method filters out clients that don't belong to the requesting
        # user
...
class ProjectUpdateView(LoginRequiredMixin, generic.edit.UpdateView):
    ...
    # TODO it should be possible to unite the redundant code in
    # ProjectCreateView and ProjectUpdateView
