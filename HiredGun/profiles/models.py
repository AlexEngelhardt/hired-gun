...
class Profile(models.Model):
    ...
    phone = models.CharField(max_length=128,
                             default="TODO please enter phone no")
    website = models.CharField(max_length=256, blank=True, null=True)

    bank_acct = models.CharField(max_length=128,
                                 default="TODO please enter bank account no")
    bank_sort_code = models.CharField(
        max_length=128,
        default="TODO please enter bank sort code"
    )
